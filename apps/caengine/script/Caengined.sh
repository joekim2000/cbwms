...
DAEMON="caengined"
DAEMON_CMD="/opt/JionLab/caengine/bin/caengined.py"
PID_FILE="caengine"
DAEMON_CMD_OPTIONS=
DAEMON_WAIT_SLEEP=5
CONFIG_FILE="/opt/JionLab/caengine/etc/caengined.conf"
LOG_DIR="/var/log/JionLab/caengine"
RC_LOG_FILE="/var/log/JionLab/caengine/Caengined.log"
MONITOR_SLEEP=60
