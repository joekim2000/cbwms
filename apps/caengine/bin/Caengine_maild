#!/bin/sh
#
# Caengine_maild.sh - Mar 10, 2017
#

RC="Caengine_maild"
PID_DIR="/var/run/JionLab/caengine"
DAEMON_DIR="/opt/JionLab/caengine/bin"
DAEMON="caengine_maild"
DAEMON_CMD="/opt/JionLab/caengine/script/maild.py"
DAEMON_WAIT_SLEEP=5
PID_FILE="mail"
DAEMON_CMD_OPTIONS=
CONFIG_FILE=
LOG_DIR="/var/log/JionLab/caengine"
RC_LOG_FILE="/var/log/JionLab/caengine/Caengine_maild.log"
MONITOR_SLEEP=60
